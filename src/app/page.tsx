...
export default function Home() {
  return (
    <main className="containers mx-auto min-w-fit w-fit px-4">
      <h2
        className={`text-3xl py-8 font-bold w-[875px] max-w-full text-slate-700 ${righteous.className}`}
      >
        Signal
      </h2>
      <div className="grid border divide-gray-200 divide-y border-gray-200 rounded-lg overflow-hidden">
        <Suspense
          fallback={
